...
/**
 * @brief Enumeration of MTCM clock source.
 */
typedef enum
{
  CKCU_MCTMSRC_AHB = 0,
...
#if (LIBCFG_LSE) || (LIBCFG_USBD) || (LIBCFG_CKCU_REFCLK_EXT_PIN)
/**
...
typedef union
{
  struct
  {
    ...
    unsigned long            :1;
    unsigned long AES        :1;
    unsigned long HTPA         :1;
    unsigned long HTPB         :1;
    unsigned long HTPC         :1;
    unsigned long HTPD         :1;
    unsigned long            :1;
    unsigned long HTPF         :1;
    unsigned long            :2;
    unsigned long DIV        :1;
    unsigned long            :7;
