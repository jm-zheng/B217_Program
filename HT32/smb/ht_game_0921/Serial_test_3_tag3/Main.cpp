	...
	//-----------------------------------------
		...
		//{
			/*while(ZIGBEE_Serial.available ())
			{
					...
					if (ZIGBEE_RxBuf[ZIGBEE_Count] == 0x24)
					{
					...
					else if (ZIGBEE_RxBuf[ZIGBEE_Count] == 0x2A)
					{
						ZIGBEE_Count =0;
						break;
					}
