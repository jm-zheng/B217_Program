...
#if (LIBCFG_CKCU_MTCM_SRC)
#define CKCU_POS_MTCMCSEL       8
#define CKCU_MASK_MTCMCSEL      ((u32)0x1 << CKCU_POS_MTCMCSEL)
#endif
...
#if (LIBCFG_CKCU_MTCM_SRC)
/*********************************************************************************************************//**
 * @brief Configure the MTCM clock source.
 * @param CKCU_MCTMSRC_x: specify the MTCM clock source.
 *   This parameter can be one of the following values:
 *     @arg CKCU_MCTMSRC_AHB    : CK_MTCM = CK_AHB
 *     @arg CKCU_MCTMSRC_USBPLL : CK_MTCM = CK_USBPLL
 * @retval None
 ************************************************************************************************************/
void CKCU_MTCMClockConfig(CKCU_MCTMSRC_TypeDef CKCU_MCTMSRC_x)
{
  Assert_Param(IS_MCTM_SRC(CKCU_MCTMSRC_x));
  CKCU_BF_WRITE(HT_CKCU->APBCFGR, CKCU_MASK_MTCMCSEL, CKCU_POS_MTCMCSEL, CKCU_MCTMSRC_x);
}
#endif
 ...
 ************************************************************************************************************/
unsigned char CKCU_IS_PLL_USED(CKCU_PLLST_TypeDef Target)
{
 ...
 * @retval TRUE or FALSE
 ************************************************************************************************************/
unsigned char CKCU_IS_HSI_USED(CKCU_HSIST_TypeDef Target)
{
 ...
 * @retval TRUE or FALSE
 ************************************************************************************************************/
unsigned char CKCU_IS_HSE_USED(CKCU_HSEST_TypeDef Target)
{
 ...
 * @retval TRUE or FALSE
 ***********************************************************************************************************/
unsigned char CKCU_HSIAutoTrimIsReady(void)
{
