...
{
  protected:
    volatile USART_InitTypeDef *_uart;
    // Has any byte been written to the UART since begin()
    bool _written;

  public:
    __IO uint16_t _rx_buffer_head;
    __IO uint16_t _rx_buffer_tail;
    __IO uint16_t _tx_buffer_head;
    __IO uint16_t _tx_buffer_tail;
    ...
    inline HardwareSerial(USART_InitTypeDef *uart);
