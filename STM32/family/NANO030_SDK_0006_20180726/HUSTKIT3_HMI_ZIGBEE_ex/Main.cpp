...
int main(void)
{
	...
	while (1)
	{
		...
		if (ZIGBEE_Get() == 1)
		{
			...
			// MACH #1
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS1",buf)==1)
			{
				HMI_SetText((char *)"tM1",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MN1",buf)==1)
			{
				HMI_SetText((char *)"tN1",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MT1",buf)==1)
			{
				HMI_SetText((char *)"tS1",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MA1",buf)==1)
			{
				HMI_SetText((char *)"tA1",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS1",buf)>=1)
			{
				HMI_SetText((char *)"tR1",buf);
			}
			// MACH #2
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS2",buf)==1)
			{
				HMI_SetText((char *)"tM2",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MN2",buf)==1)
			{
				HMI_SetText((char *)"tN2",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MT2",buf)==1)
			{
				HMI_SetText((char *)"tS2",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MA2",buf)==1)
			{
				HMI_SetText((char *)"tA2",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS2",buf)>=1)
			{
				HMI_SetText((char *)"tR2",buf);
			}
			// MACH #3
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS3",buf)==1)
			{
				HMI_SetText((char *)"tM3",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MN3",buf)==1)
			{
				HMI_SetText((char *)"tN3",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MT3",buf)==1)
			{
				HMI_SetText((char *)"tS3",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MA3",buf)==1)
			{
				HMI_SetText((char *)"tA3",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS3",buf)>=1)
			{
				HMI_SetText((char *)"tR3",buf);
			}
			// MACH #4
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS4",buf)==1)
			{
				HMI_SetText((char *)"tM4",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MN4",buf)==1)
			{
				HMI_SetText((char *)"tN4",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MT4",buf)==1)
			{
				HMI_SetText((char *)"tS4",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MA4",buf)==1)
			{
				HMI_SetText((char *)"tA4",buf);
			}
			if (jsonGet((char *)ZIGBEE_RxBuf,(char *)"MS4",buf)>=1)
			{
				HMI_SetText((char *)"tR4",buf);
			}
		}		
	}
}
