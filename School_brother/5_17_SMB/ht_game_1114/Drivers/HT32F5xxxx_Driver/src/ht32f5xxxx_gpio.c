...
void GPIO_DeInit(HT_GPIO_TypeDef* HT_GPIOx)
{
  ...
  {
    RSTCUReset.Bit.HTPA = 1;
  }
  else if (HT_GPIOx == HT_GPIOB)
  {
    RSTCUReset.Bit.HTPB = 1;
  }
  #if (LIBCFG_GPIOC)
  else if (HT_GPIOx == HT_GPIOC)
  {
    RSTCUReset.Bit.HTPC = 1;
  }
  #endif
  #if (LIBCFG_GPIOD)
  else if (HT_GPIOx == HT_GPIOD)
  {
    RSTCUReset.Bit.HTPD = 1;
  }
  #endif
  #if (LIBCFG_GPIOF)
 ...
 ************************************************************************************************************/
unsigned char GPIO_IsPortLocked(HT_GPIO_TypeDef* HT_GPIOx)
{
 ...
 * @retval TRUE or FALSE
 ************************************************************************************************************/
unsigned char GPIO_IsPinLocked(HT_GPIO_TypeDef* HT_GPIOx, u16 GPIO_PIN_n)
{
  unsigned char result;
  GPIO_CK_ST;
