...
uint8_t asd[] = {0x55,0x55,0x0B,0x03,0x02,0x20,0x03,0x02,0xB0,0x04,0x09,0xFC,0x08 };

uint8_t asd2[] = {0x55,0x55,0x08,0x03,0x01,0xE8,0x03,0x01,0xD0,0x07  };
//動作
//----------------------------------------------------------------------------------------
...
//下
uint8_t Server1[]             ={0x55,0x55,0x0E,0x03,0x03,0xE8,0x03,0x05,0x1B,0x06,0x04,0x53,0x02,0x03,0xD2,0x05};
//下
...
//下降
//------------------------------------------------------------------------------------------
uint8_t Server23[]            ={0x55,0x55,0x08,0x03,0x01,0xE8,0x03,0x04,0x65,0x04};
//下降
//------------------------------------------------------------------------------------------
void setup()
{
...
void loop() 
{
  ...
  if(digitalRead(key2) == LOW)
  {
    ...
    {
      key2_flag =1;
    for(i=0;i<10;i++){Serial.write(asd2[i]);}
    }
  }
  else key2_flag =0;
  ...
  else if(rx_data[0]=='C')
  {
    ...
    switch(a)
   {
       ...
       case 0x31 ://-----第二--------------------------------
      {
        ...
        for(int i=0;i<10;i++){Serial.write(Server6 [i]);}
        delay(2500);
        for(int i=0;i<10;i++){Serial.write(Server23 [i]);}
        delay(2500);
        for(int i=0;i<25;i++){Serial.write(REST [i]);}
